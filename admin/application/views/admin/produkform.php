				...
				<div class="card-body">
					...
					<div class="row p-lr-15">
						<div class="form-group col-md-6">
							...
							<input type="text" class="form-control" placeholder="contoh: Warna/Rasa" name="variasi" value="<?php echo ($id != 0) ? $data->variasi : ""; ?>" required />
						</div>
						<div class="form-group col-md-6">
							<label>Nama Sub Variasi</label>
							<input type="text" class="form-control" placeholder="contoh: Size/Character" name="subvariasi" value="<?php echo ($id != 0) ? $data->subvariasi : ""; ?>" required />
						</div>
	...
	$(function(){
		...
		$("#variasi").on('click','.hapusvariasion',function(){
			...
			swal.fire({
				...
				if(val.value){
					$.post("<?=site_url('Admin/hapusvariasi')?>",{"theid":varid},function(e){
						var data = eval("("+e+")");
