...
<a href="<?=site_url("Admin/produkform")?>" class="btn btn-success float-right m-r-10"><i class="fas fa-plus-circle"></i> Produk Baru</a>
...
<script type="text/javascript">
	$(function(){
		$.post("<?=site_url("Admin/produk?load=true")?>&page=1",{"cari":$("#cari").val()},function(msg){
			$(".card-body").html(msg);
		});
		...
		$("#cari").change(function(){
			...
			$.post("<?=site_url("Admin/produk")?>?page=1&load=true",{"cari":$("#cari").val()},function(msg){
				$(".card-body").html(msg);
			});
		});
	});
	...
	function refreshTabel(page){
		$(".card-body").html('<i class="fas fa-spin fa-spinner"></i> Loading data...');
		$.post("<?=site_url("Admin/produk?load=true")?>&page="+page,{"cari":$("#cari").val()},function(msg){
			$(".card-body").html(msg);
		});
	}
