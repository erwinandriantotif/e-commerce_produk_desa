			...
			<div class="row">
				...
				<div class="col-md-6 col-lg-5 p-b-20">
					...
					<div class="m-t-20 sharer">
							...
							<a href="http://www.facebook.com/sharer.php?u=<?=site_url("produk/".$data->url)?>" class="btn btn-primary m-r-4" target="_blank">
								<i class="fab fa-facebook-f fs-20 m-lr-4 m-t-4"></i>
							</a>
							<a href="https://plus.google.com/share?url=<?=site_url("produk/".$data->url)?>" class="btn btn-danger m-r-4" target="_blank">
								<i class="fab fa-google-plus-g fs-20 m-t-4"></i>
							</a>
							<a href="https://twitter.com/share?url=<?=site_url("produk/".$data->url)?>" class="btn btn-info m-r-4" target="_blank">
