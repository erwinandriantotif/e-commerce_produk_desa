...
?>
                  ...
                  foreach($row->result() as $als){
                    ...
                    echo "
                      <div class='alamat section bg-medium p-tb-20 p-lr-24 m-t-20' id='alamat_".$als->id."' data-tujuan='".$al->idkec."' style='display:none;'>
                        <b class='text-primary'>Nama Penerima:</b><br/>".strtoupper(strtolower($als->nama))."<br/>
                        <b class='text-primary'>No HP:</b><br/>".$als->nohp."<br/>
                        <b class='text-primary'>Alamat Lengkap:</b><br/>".strtoupper(strtolower($als->alamat."<br/>".$kec.", ".$kab))."<br/>KODEPOS ".$als->kodepos."
                      </div>
                    ";
                  }
                ?>
  ...
  <script type="text/javascript">
    ...
    function calculateOngkir(){
      ...
      var totalbayar = sum + parseFloat($("#subtotal").val());
