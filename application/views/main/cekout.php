	...
	<form class="p-t-0 p-b-85">
		<div class="container p-t-20 p-b-50">
			<div class="row">
						...
						<div class="p-b-13">
							...
							<div class="col-2">
								<i class="fas fa-check-circle text-success fs-54"></i>
									...
									<h5 class="text-black p-b-10">Order ID</h5>
									<p class="color1"><?php echo $data->invoice; ?></p>
								</div>
								<div class="col-md-3">
				...
				</div>	<div class="col-md-12 m-b-30">
					<h4 class="text-primary font-bold p-b-20">
						Pembayaran
					</h4>
						...
						?>
							<div class="p-b-13">
								<div class="row">
									...
									<div class="col-md-6 metode-bayar row m-b-20">
										...
										?>
										<div class="col-md-6 m-b-12 p-lr-6">
											<div class="metode-item " onclick="bayarMidtrans()">
												<i class="cek fas fa-check-circle fs-24"></i>
							...
							<a href="javascript:void(0)" onclick="payMidtrans()" class="btn btn-primary btn-block btn-lg text-center bayarmidtrans m-t-30" style="display:none;"><i class="fa fa-chevron-circle-right"></i> &nbsp;<b>BAYAR SEKARANG</b></a>
							...
							<a href="<?php echo site_url("assync/bayaripaymu/".$data->id); ?>" style="display:none;" class="btn btn-primary btn-block btn-lg text-center bayarotomatis m-t-30"><i class="fa fa-chevron-circle-right"></i> &nbsp;<b>BAYAR SEKARANG</b></a>
							...
							<a href="<?php echo site_url("manage/pesanan?konfirmasi=".$data->id); ?>" style="display:none;" class="btn btn-primary btn-block btn-lg text-center bayarmanual m-t-30"><b>KONFIRMASI PEMBAYARAN</b> &nbsp;<i class="fa fa-chevron-circle-right"></i></a>
						<?php
							}else{
						?>
							<div class="p-b-13">
