      ...
      ?>
			...
			<div class="p-t-18 p-b-15 p-lr-40 p-lr-15-sm m-b-90">
				<div class="row">
					...
					<div class="col-md-4">
						<h5 class="m-b-20 font-bold text-danger text-right">Total : Rp <span id="totalbayar" style="padding-left:40px"><?php echo $this->func->formUang($totalbayar); ?></span></h5>
					</div>
				</div>
				<div class="row">
					<div class="col-md-6"></div>
					<div class="col-md-3 m-b-10 p-lr-6">
						<a href="<?php echo site_url("shop"); ?>" class="btn btn-warning btn-lg btn-block">
							Kembali Berbelanja
						</a>
					</div>
					<div class="col-md-3 m-b-10 p-lr-6">
		...
		?>
			<div class="row p-lr-16">
				<div class="col-lg-12 m-lr-auto p-tb-150 m-t-40 m-b-150 text-light bg-warning" style="border-radius: 16px;">
					<div class="m-lr-0-xl text-center">
						<h3 class="text-light">Keranjang belanja masih kosong.</h3>
					</div>
				</div>
			</div>
		<?php
