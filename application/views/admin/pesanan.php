		...
		<div class="container">
			...
			<div class="tab">
				<div class="tab-header">
					<a class="navlink belumbayar btn btn-warning m-r-8 m-b-8" href="javascript:void(0)" data-link="#belumbayar"><i class="fas fa-money-check-alt"></i> Belum Bayar</a>
					<a class="navlink dikemas btn btn-primary m-r-8 m-b-8" href="javascript:void(0)" data-link="#dikemas"><i class="fas fa-box"></i> Dikemas</a>
					<a class="navlink dikirim btn btn-primary m-r-8 m-b-8" href="javascript:void(0)" data-link="#dikirim"><i class="fas fa-shipping-fast"></i> Dikirim</a>
					<a class="navlink selesai btn btn-primary m-r-8 m-b-8" href="javascript:void(0)" data-link="#selesai"><i class="fas fa-clipboard-check"></i> Selesai</a>
					<a class="navlink batal btn btn-primary m-r-8 m-b-8" href="javascript:void(0)" data-link="#batal"><i class="fas fa-times"></i> Dibatalkan</a>
					<a class="navlink preorder btn btn-primary m-r-8 m-b-8" href="javascript:void(0)" data-link="#preorder"><i class="fas fa-hourglass-half"></i> Preorder</a>
				</div>
  	...
  	<script type="text/javascript">
		$(function(){
			...
			$(".navlink").each(function(){
				...
				$(this).click(function(){
					$(".navlink.btn-warning").addClass("btn-primary");
					$(".navlink.btn-warning").removeClass("btn-warning");
