				...
				<div class="row m-lr-0">
					<div class="col-md-8 p-lr-0 m-b-10">
						...
						<div class="p-b-30 p-r-10">
							<a href="javascript:void(0)" class="view-product"><i class="fas fa-chevron-circle-down"></i> Lihat produk lainnya</a>
							<a href="javascript:void(0)" class="view-product" style="display:none;"><i class='fas fa-chevron-circle-up'></i> Sembunyikan produk</a>
						</div>
						<?php
							}
						?>
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="row">
								...
								?>
								<div class="col-md-6">
									<a href="javascript:void(0)" onclick="<?=$klik?>" class="btn btn-primary btn-block m-b-10">
										Bayar Pesanan
									</a>
								</div>
								<div class="col-md-6">
									<a href="javascript:void(0)" onclick="konfirmasi(<?php echo $res->id; ?>)" class="btn btn-success btn-block m-b-10">
										Konfirmasi
									</a>
								</div>
								<?php
