	...
	<div class="p-t-30">
		<div class="container p-b-20">
            ...
            <div class="row p-lr-20">
                <div class="col-md-6 m-l-auto m-r-auto m-b-80">
						...
						<form id="signin_otp" class="p-t-50 p-b-50 p-lr-30">
							...
							<div class="m-b-60 row">
                                <div class="col-2 p-lr-4">
                                    <input class="form-control p-tb-24 p-lr-10 fs-20 font-bold text-center" type="text" data-split="1" id="otp_1" placeholder="" required >
                                </div>
                                <div class="col-2 p-lr-4">
                                    <input class="form-control p-tb-24 p-lr-10 fs-20 font-bold text-center" type="text" data-split="2" id="otp_2" placeholder="" required >
                                </div>
                                <div class="col-2 p-lr-4">
                                    <input class="form-control p-tb-24 p-lr-10 fs-20 font-bold text-center" type="text" data-split="3" id="otp_3" placeholder="" required >
                                </div>
                                <div class="col-2 p-lr-4">
                                    <input class="form-control p-tb-24 p-lr-10 fs-20 font-bold text-center" type="text" data-split="4" id="otp_4" placeholder="" required >
                                </div>
                                <div class="col-2 p-lr-4">
                                    <input class="form-control p-tb-24 p-lr-10 fs-20 font-bold text-center" type="text" data-split="5" id="otp_5" placeholder="" required >
                                </div>
                                <div class="col-2 p-lr-4">
                                    <input class="form-control p-tb-24 p-lr-10 fs-20 font-bold text-center" type="text" data-split="6" id="otp_6" placeholder="" required >
                                </div>
							</div>
...
<script type="text/javascript">
    ...
    function submitChallenge(){
		...
		$.post("<?php echo site_url("home/signin_otp/confirm"); ?>",{"otp":otp},function(msg){
			var data = eval('('+msg+')');
    ...
    function kirimUlang(){
        ...
        $("#kirimulang").hide();
        $("#detikan").show();
		$.post("<?php echo site_url("home/signin_otp/resend"); ?>",{"otp":true},function(msg){
			var data = eval('('+msg+')');
			if(data.success == true){
                startTimer(90);
			}else{
